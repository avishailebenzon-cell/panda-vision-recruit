...
export default function MobileGcPage() {
    ...
    const loadData = async () => {
      try {
        const [matchesData, jobsData, candidatesData, statusesData] = await Promise.all([
          base44.entities.Match.filter({ user_app_role: "gc" }, '-created_date'),
  ...
  if (loading) return <div className="flex items-center justify-center min-h-[60vh]"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-gray-500"></div></div>;

  return (
    <div className="space-y-3">
      <Card className="bg-gradient-to-r from-gray-100 to-gray-50"><CardHeader className="pb-3"><CardTitle className="text-lg">GC - סוכן כללי</CardTitle></CardHeader></Card>
