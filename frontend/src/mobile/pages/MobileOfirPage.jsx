...
export default function MobileOfirPage() {
    ...
    const loadData = async () => {
      try {
        const [matchesData, jobsData, candidatesData, statusesData] = await Promise.all([
          base44.entities.Match.filter({ user_app_role: "ofir" }, '-created_date'),
  ...
  return (
    <div className="space-y-3">
      <Card className="bg-gradient-to-r from-emerald-100 to-emerald-50"><CardHeader className="pb-3"><CardTitle className="text-lg">אופיר - מומחה הנדסת מכונות</CardTitle></CardHeader></Card>
